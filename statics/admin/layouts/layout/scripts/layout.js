...
var Layout = function () {
    ...
    var layoutImgPath = sys_theme+'layouts/layout/img/';

    var layoutCssPath = sys_theme+'layouts/layout/css/';
    ...
    var handleSidebarToggler = function () {
        var body = $('body');
        if (body.attr('index') != 'nheader' && $.cookie && $.cookie('sidebar_closed') === '1' && App.getViewPort().width >= resBreakpointMd) {
