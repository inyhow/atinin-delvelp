...
class Tag_model extends CI_Model {
	...
	public function tag($code) {
		...
		return $this->link->where('code', $code)->get($this->tablename)->result_array();
	}
	...
	public function get($id) {
		...
		return $this->link->where('id', $id)->limit(1)->get($this->tablename)->row_array();
	}
