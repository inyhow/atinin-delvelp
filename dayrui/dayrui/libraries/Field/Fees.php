			...
			if ($group['id'] > 2) {
				...
				foreach ($group['level'] as $level) {
					...
					if($level['id']!=1 && $level['id']!=5){
						$str.= '<td align="left" width="250" style="padding-left:40px">'.$level['name'].'&nbsp;&nbsp;<img src="./statics/home/images/'.$level['id'].'.png" alt="" style="width:25px;height:25px;"></td>';
					}else{
						$str.= '<td align="left" width="250" style="padding-left:40px">'.$level['name'].'&nbsp;&nbsp;</td>';
					}
					$str.= '<td align="left">';
