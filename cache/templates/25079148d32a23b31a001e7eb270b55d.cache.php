    ...
    <div class="gb_newsn">
        <div class="gb_news_l">
            ...
            <div style="float:left; line-height:30px; padding-top:0px;" id="Marquee">
                <ul>
                    ...
                    <li style="float:left;">
                        <a href="<?php echo $t['url']; ?>">新闻动态：<?php echo dr_strcut($t['title'], 60); ?></a>
        ...
        <div class="gb_news_r">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="9%">&nbsp;</td>
                    <td width="69%" align="right" style="color:#FFFFFF;font-size:16px;font-family:微软雅黑">联系客服:</td>
...
<div class="gb_footer">
    <div style="height:80px;">
        <div class="gb_footer_l">版权所有：<?php echo dr_block(1); ?> All Rigthts Reserved
        </div>
        <div class="gb_footer_r" style="padding-top:10px">
