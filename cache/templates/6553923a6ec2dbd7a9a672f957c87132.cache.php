...
<div id="container2">
    <div id="mainBody_in">
        <div class="right_in_right_titile">
            ...
            <div class="position_now"> <img src="skin/images/home_btnsd.gif" width="17" height="19" align="absmiddle" />&nbsp;&nbsp; <img src="skin/images/jiantou.gif" align="absmiddle" />&nbsp;&nbsp; <a href="<?php echo SITE_URL; ?>">Home</a>&nbsp;&nbsp;<img src="skin/images/jiantou.gif" align="absmiddle" /> &nbsp;&nbsp;<span class="color4c5560"></span><a href=""><?php echo $name; ?></a>
            </div>
        </div>
        <!--中间内容开始-->
        <div id="left">
                    ...
                    <div id="DivList">
                        ...
                        <div id="Div_<?php echo $t['id']; ?>" class="sub" style="display:none; width:100%;">
                            <div style="">
                                ...
                                <div style="padding-left:10px;font-family:微软雅黑;font-size:14px;text-align:left;line-height:26px"> <a title="<?php echo $t2['name']; ?>" class="pro_erjimenubg_" href="<?php echo $t2['url']; ?>" name="sub" id="<?php echo $t['id']; ?>"><span style="font-size:10px"></span><?php echo $t2['name']; ?></a></div>
