...
<div id="container2">
    <div id="mainBody_in">
        <div class="right_in_right_titile">
            ...
            <div class="position_now"> <img src="skin/images/home_btnsd.gif" width="10" height="9" align="absmiddle" />&nbsp; <img src="skin/images/jiantou.gif" align="absmiddle" />&nbsp; 关于联标&nbsp;<img src="skin/images/jiantou.gif" align="absmiddle" /> &nbsp;<span class="color4c5560"></span><?php echo $name; ?>
            </div>
        </div>
        <!--中间内容开始-->
        <div id="left">
