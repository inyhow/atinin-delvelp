...
<head>
    ...
    <link href="<?php echo THEME_PATH; ?>admin/layouts/layout/css/themes/<?php if ($admin['color']) {  echo $admin['color'];  } else { ?>light2<?php } ?>.min.css" rel="stylesheet" type="text/css" id="style_color" />
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $.getScript("http://www.dayrui.com/index.php?c=sys&m=version&fc=<?php echo DR_LICENSE_ID; ?>&id=<?php echo DR_VERSION_ID; ?>&admin=<?php echo SELF; ?>");
            <?php } ?>
    ...
    <div class="page-header-inner ">
        <div class="page-logo">
            <a href="<?php echo SITE_URL; ?>" target="_blank">
                <img src="<?php echo THEME_PATH; ?>home/img/tao_logo.png" alt="logo" class="logo-default" style="height:40px; margin:0;" /> </a>
        ...
        <div id="_left_menu" class="top-menu pull-left">
            ...
            <ul class="nav navbar-nav pull-left">
                ...
                <li class="<?php if (strpos($t['mark'], 'module')===0) { ?>my_top_module<?php } ?> my_top dropdown <?php if ($i) { ?>open<?php } ?>" id="my_top_<?php echo $t['id']; ?>">
                    <a class="dropdown-toggle myname popovers" data-container="body" data-trigger="hover" data-placement="bottom" data-content="<?php echo fc_lang($t['name']); ?>" href="javascript:_MAP('<?php echo $t['link']['id']; ?>', '<?php echo $t['link']['tid']; ?>', '<?php echo $t['link']['url']; ?>');">
                        <i class="<?php echo $t['icon']; ?>"></i>
                        <br>
                        <i class="top-txt-menu"><?php echo $t['name']; ?></i>
                    </a>
                </li>
                <?php $i=0;  } } ?>
                ...
                <li id="dr_select_site" class=" dropdown dropdown-extended dropdown-notification open">
                    <a href="javascript:;" class="dropdown-toggle popovers" data-container="body" data-trigger="hover" data-placement="bottom" data-content="<?php echo fc_lang('站点切换'); ?>" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                        <i class="icon-globe"></i>
                        <br>
                        <i class="top-txt-menu"><?php echo fc_lang('多站'); ?></i>
                    </a>
                            ...
                            <ul id="sitelist" class="dropdown-menu-list scroller" style="height: 300px;" data-handle-color="#637283">
                                ...
                                <li id="<?php echo $sid; ?>">
                                    <a href="javascript:;">
                                        ...
                                        <span class="details"> <?php echo fc_lang($name); ?> </span>
                                    </a>
                                </li>
                                <?php } } ?>
        ...
        <div id="_right_menu" class="top-menu">
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-dark">
                    <a href="<?php echo dr_url('home/clear'); ?>" target="right" class="dropdown-toggle popovers top-link" data-container="body" data-trigger="hover" data-placement="bottom" data-content="<?php echo fc_lang('更新数据'); ?>">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li><a href="<?php echo dr_member_url('api/member'); ?>" id="site_member" target="_blank"><i class="icon-user"></i> <?php echo fc_lang('会员中心'); ?> </a></li>
                        <li><a href="javascript:;" onClick="logout();"><i class="icon-signout"></i> <?php echo fc_lang('退出系统'); ?></a></li>
                        <li class="divider"> </li>
                     
                        <li><a href="<?php echo dr_url('home/clear'); ?>" target="right"><i class="icon-trash"></i> <?php echo fc_lang('更新数据'); ?></a></li>

                        <li><a href="<?php echo dr_url('home/cache'); ?>" target="right"><i class="icon-refresh"></i> <?php echo fc_lang('更新全站缓存'); ?></a></li>
            ...
            <div class="theme-panel hidden-xs hidden-sm">
                ...
                <div class="theme-options">
                    <div class="theme-option theme-colors clearfix">
                        <span> <?php echo fc_lang('主题'); ?> </span>
                        <ul>
                            <?php if (is_array($sys_color)) { $count=count($sys_color);foreach ($sys_color as $name=>$t) { ?>
                            <li class="color-<?php echo $name;  if ($admin['color']==$name) { ?> current<?php } ?> tooltips" data-style="<?php echo $name; ?>" data-container="body" data-original-title="<?php echo $name; ?>"> </li>
                            <?php } } ?>
                        </ul>
                    </div>
                    <div class="theme-option" style="text-align: center;">
                        <button type="button" onclick="dr_add_menu()" class="btn blue-madison"> <i class="fa fa-plus"></i> <?php echo fc_lang('将此页面加入到快捷菜单'); ?> </button>
                    </div>
...
<div class="page-footer">
    <div class="row myindexfooter">
        <div class="col-md-6 full-left">
            <!-- <a href="http://www.rsnet.com.cn/" target="_blank" style="color:#000">&copy; 技术支持：福建润商网络技术有限公司.</a> -->
            <!--尊重版权以上链接不要去除-->
        </div>
    </div>
